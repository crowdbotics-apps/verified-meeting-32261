...
## Project Structure
    ...
    ├── verified_meeting_32261  # Django project configurations
...
1. Clone this repo and `cd verified_meeting_32261`
...
2. Clone this repo and `cd verified_meeting_32261`
